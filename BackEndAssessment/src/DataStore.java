...
public class DataStore {
  ...
  //Parameterized constructor of class DataStore
    
    DataStore(String path) throws JSONException {
        FilePath = path;
   ...
   //Default constructor of class DataStore
    
    DataStore() throws JSONException {
        FilePath = "F://DataFile.JSON";
        JSONObject fill = new JSONObject();
        fill.put(" ", " ");      //Fill JSONobject with dummy value
         try (FileWriter file = new FileWriter(FilePath,false))
        		{
   ...
   // Creates Entry to JSON file , accepting TimeToLive parameter
    ...
    {    
         ...
         try (FileReader reader = new FileReader(FilePath)) {
            ...
            System.out.println("KEY already exists !! . Duplicate keys are not allowed");
